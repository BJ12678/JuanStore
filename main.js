              ...
              <tfoot>
                <tr>
                  ...
                  <th>
                    ...
                    .reduce((currentTotal, sale) => { return sale.item +
                    currentTotal; }, 0) * 20 ).toLocaleString('en') }}php
                  </th>
                  <th>
                    {{ ( sales .filter((sale) =>
                    sale.date.match(this.select_year) )
                    .reduce((currentTotal, sale) => { return sale.payments +
                    currentTotal; }, 0) * 20 ).toLocaleString('en') }}php
                  </th>
                  <th>
                    {{ items .filter((item) =>
                    item.date.match(this.select_year) )
                    .reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) .toLocaleString('en') }}php
                  </th>
                  <th>
                    {{ ( sales .filter((sale) =>
                    sale.date.match(this.select_year) )
                    .reduce((currentTotal, sale) => { return sale.payments +
                    currentTotal; }, 0) * 20 - items .filter((item) =>
                    item.date.match(this.select_year) )
                    .reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) ).toLocaleString('en') }}php
                  </th>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    currentTotal; }, 0) * 20 ).toLocaleString('en') }}
                  </td>
                  <td>
                    {{ ( January.filter((sale) =>
                    sale.date.match(this.select_year)
                  ...
                  <td>
                    ...
                    item.date.match(this.select_year) )
                    .reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) .toLocaleString('en') }}
                  </td>
                  <td>
                    {{ ( January.filter((sale) =>
                    sale.date.match(this.select_year)
                    ).reduce((currentTotal, sale) => { return sale.payments
                    + currentTotal; }, 0) * 20 - January_.filter((item) =>
                    item.date.match(this.select_year)
                    ).reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) ).toLocaleString('en') }}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    + currentTotal; }, 0) * 20 - February_.filter((item) =>
                    item.date.match(this.select_year)
                    ).reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) ).toLocaleString('en') }}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    + currentTotal; }, 0) * 20 - March_.filter((item) =>
                    item.date.match(this.select_year)
                    ).reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) ).toLocaleString('en') }}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    + currentTotal; }, 0) * 20 - April_.filter((item) =>
                    item.date.match(this.select_year)
                    ).reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) ).toLocaleString('en') }}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    + currentTotal; }, 0) * 20 - May_.filter((item) =>
                    item.date.match(this.select_year)
                    ).reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) ).toLocaleString('en') }}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    + currentTotal; }, 0) * 20 - June_.filter((item) =>
                    item.date.match(this.select_year)
                    ).reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) ).toLocaleString('en') }}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    + currentTotal; }, 0) * 20 - July_.filter((item) =>
                    item.date.match(this.select_year)
                    ).reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) ).toLocaleString('en') }}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    + currentTotal; }, 0) * 20 - August_.filter((item) =>
                    item.date.match(this.select_year)
                    ).reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) ).toLocaleString('en') }}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    + currentTotal; }, 0) * 20 - September_.filter((item) =>
                    item.date.match(this.select_year)
                    ).reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) ).toLocaleString('en') }}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    + currentTotal; }, 0) * 20 - October_.filter((item) =>
                    item.date.match(this.select_year)
                    ).reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) ).toLocaleString('en') }}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    + currentTotal; }, 0) * 20 - November_.filter((item) =>
                    item.date.match(this.select_year)
                    ).reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) ).toLocaleString('en') }}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    + currentTotal; }, 0) * 20 - December_.filter((item) =>
                    item.date.match(this.select_year)
                    ).reduce((currentTotal, item) => { return item.amount +
                    currentTotal; }, 0) ).toLocaleString('en') }}
                  </td>
