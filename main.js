                  ...
                  <tfoot>
                    <tr>
                      ...
                      <th>
                        {{ ( sales .filter((sale) =>
                        sale.date.match(this.select_year) )
                        .reduce((currentTotal, sale) => { return
                        sale.payments + currentTotal; }, 0) * 20
                        ).toLocaleString('en') }}php
                      </th>
                      <th>
                        {{ items .filter((item) =>
                      ...
                      <th>
                        ...
                        sale.date.match(this.select_year) )
                        .reduce((currentTotal, sale) => { return
                        sale.payments + currentTotal; }, 0) * 20 - items
                        .filter((item) => item.date.match(this.select_year)
                        ) .reduce((currentTotal, item) => { return
                        item.amount + currentTotal; }, 0)
                        ).toLocaleString('en') }}php
                      </th>
                    </tr>
                  </tfoot>
